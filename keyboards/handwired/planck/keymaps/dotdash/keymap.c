...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,  KC_LGUI, FUNC(4), KC_RALT, KC_LSFT, FUNC(1), FUNC(1),  FUNC(2), MO(_FN), KC_HOME, KC_END, KC_ESC
    ),
    [_FN] = LAYOUT( /* Function */
    KC_GRV,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGUP, KC_UP,   KC_PGDN, KC_BSLS, KC_BSPC,
    KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS, KC_END,  KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT, KC_ENT,
    ...
    [5] = LAYOUT( /* Numpad function layer */
