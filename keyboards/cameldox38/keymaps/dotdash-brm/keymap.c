...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  |             |             |               |             |             |             |             |              |             |
        ...
        LSFT_T(KC_A), LGUI_T(KC_S), LT(_SYM, KC_D), LCTL_T(KC_F), LALT_T(KC_G), RALT_T(KC_H), RCTL_T(KC_J), LT(_SYM,KC_K), RALT_T(KC_L), RSFT_T(KC_B)
        KC_NO,        KC_Z,         KC_X,           LGUI_T(KC_C), KC_V,         RGUI_T(KC_N), KC_M,         KC_COMM,       KC_DOT,          _______
    ...
    //  |             |             |               |             |               |               |                |                 |                 |
        ...
        LSFT_T(KC_A), LGUI_T(KC_S), LT(_SYM, KC_D), LCTL_T(KC_F), LALT_T(KC_TAB), RALT_T(KC_LEFT), RCTL_T(KC_DOWN), LT(_SYM,KC_UP), RALT_T(KC_RIGHT), RSFT_T(KC_ENT),
                      KC_Z,         KC_X,           LGUI_T(KC_C), KC_V,           KC_LBR,          RGUI_T(KC_RBR),  _______,        _______,       _______,      _______,
                      _______,      _______,        _______,      _______,        _______,         _______,      _______,       _______
    ),
