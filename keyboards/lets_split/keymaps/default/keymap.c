 ...
 * |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  
 * |------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |Lower |Space |Space |Raise | Left | Down |  Up  |
 * `---------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
...
>>>>>>> 01f0c16578e42d3c01040ea882119e6037d9fca9
),
...
[_ADJUST] =  KEYMAP( \
  ...
  _______, _______, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, \
