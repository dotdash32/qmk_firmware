...
[_ADJUST] =  KEYMAP( \
  ...
  KC_F11,  KC_F12, _______,TG(_GAME), _______,      _______, _______, _______, TSKMGR, CALTDEL, \
  RESET,   _______, _______, _______, _______,      _______, _______, _______, _______,  _______, \
                    _______, _______, _______,      _______,  _______, _______                    \
),
[_GAME] =  KEYMAP( \
  KC_Q,    XXXXXXX,    KC_W,    KC_E, KC_TILD,      _______, _______, _______, _______,  _______, \
  KC_RSFT,    KC_A,    KC_S,    KC_D, XXXXXXX,      _______, _______, _______, _______,  _______,\
  RESET,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      _______, _______, _______, _______,  _______, \
                     KC_ESC,  KC_TAB,  KC_SPC,      TO(_QWERTY),  _______, _______                    \
)
};
